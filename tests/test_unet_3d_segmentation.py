...
DIR_TARGET = os.path.join(DIR_ROOT, 'data/test_masks/')
...
def test_image_segmentation():
    ...
    Network_Hyperparameters = {'network': 'UNet',
                            'dimension': '3D',
                            'activation': 'ReLU',
                            'normalization': 'None'}
    ...
    Preprocessing_List = {'spectral_crop_start': 150,
    ...
    Task_Options = {'task': 'Segmentation', 'classes': 5}
