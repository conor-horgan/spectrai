...
parser = argparse.ArgumentParser(description='spectrai: evaluate a pretrained model')
...
def main():
    ...
    output = trainer.evaluate_pretrained(Training_Options, Task_Options, Network_Hyperparameters, Training_Hyperparameters, Preprocessing, 
