...
parser = argparse.ArgumentParser(description='spectrai: train a model from scratch')
...
parser.add_argument('--save_frequency', default=0, type=int)
...
def main():
    ...
    output = trainer.train_epoch(Training_Options, Task_Options, Network_Hyperparameters,
                                ...
                                scheduler_state_dict, epochs, results_preview = 0, current_epoch = 1,
                                max_epochs = epochs, save_frequency = args.save_frequency, verbose = args.verbose)
